...
LA1:
	...
	BREQ DIVISIBLE
	; If neither are met, then contintue to subtract by 3
	RJMP LA1

DIVISIBLE:
	ST   Y+, R20 ; Store current value in Divisble List
...
NOTDIVISIBLE:
	ST   Z+, R20 ; Store current value in Not Divisble List
	LDI R25, 0 ; For Convenience
